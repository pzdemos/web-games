...
export const CHARS = [
  {
    ...
    sp1: { kind: 'proj', visual: 'ball', name: '气功弹', dmg: 92, speed: 7.5, startup: 12, recover: 20, guard: 'mid', kb: 6, cd: 100 },
    sp2: { kind: 'riser', name: '升龙裂拳', dmg: 128, hits: 3, startup: 5, recover: 26, invuln: 9, launcher: true, cd: 140, guard: 'mid' },
  ...
  },
  {
    ...
    sp1: { kind: 'proj', visual: 'ball', name: '真空剑气', dmg: 96, speed: 8.2, startup: 11, recover: 19, guard: 'mid', kb: 6, cd: 100 },
    sp2: { kind: 'riser', name: '拔山斩', dmg: 132, hits: 3, startup: 6, recover: 27, invuln: 8, launcher: true, cd: 140, guard: 'mid' },
  ...
  },
  {
    ...
    sp1: { kind: 'proj', visual: 'ball', name: '烈焰火球', dmg: 100, speed: 6.8, startup: 13, recover: 21, guard: 'mid', kb: 7, cd: 100 },
    sp2: { kind: 'riser', name: '烈焰升踢', dmg: 126, hits: 3, startup: 6, recover: 26, invuln: 8, launcher: true, cd: 140, guard: 'mid' },
  ...
  },
  {
    ...
    sp1: { kind: 'proj', visual: 'ball', name: '追踪气弹', dmg: 76, speed: 8.8, startup: 10, recover: 16, guard: 'mid', kb: 4, cd: 100 },
    sp2: { kind: 'riser', name: '旋风升踢', dmg: 120, hits: 3, startup: 5, recover: 24, invuln: 8, launcher: true, cd: 140, guard: 'mid' },
  ...
  },
  {
    ...
    sp1: { kind: 'proj', visual: 'ball', name: '电光球', dmg: 88, speed: 8.6, startup: 11, recover: 18, guard: 'mid', kb: 5, cd: 100 },
    sp2: { kind: 'riser', name: '电光升龙拳', dmg: 124, hits: 3, startup: 5, recover: 25, invuln: 9, launcher: true, cd: 140, guard: 'mid' },
  ...
  },
  {
    ...
    sp1: { kind: 'dash', name: '铁甲冲撞', dmg: 118, startup: 10, active: 14, recover: 26, speed: 9.5, guard: 'mid', kb: 8, cd: 100, knockdown: true },
    sp2: { kind: 'riser', name: '雷拳上击', dmg: 130, hits: 2, startup: 7, recover: 28, invuln: 6, launcher: true, cd: 140, guard: 'mid' },
